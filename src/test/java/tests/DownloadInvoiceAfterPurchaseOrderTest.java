...
public class DownloadInvoiceAfterPurchaseOrderTest extends BaseTest {
    ...
    @TmsLink("KAN-T24")
    @Description("Verify user can download invoice after placing an order")
    @Test
    public void downloadInvoiceAfterPurchaseOrderTest() {
        ...
        DownloadFilePage downloadFilePage = new DownloadFilePage(browser);
        ...
        // download file page
        downloadFilePage.clickDownloadInvoiceButton();

       // String downloadPath=System.getProperty("user.dir")+"\\downloads";
        Assert.assertTrue(downloadFilePage.waitForFileToDownload(  "C:\\Users\\user1\\AppData\\Local\\Temp", "invoice",20));
        downloadFilePage.clickContinueButton();
        //delete account
